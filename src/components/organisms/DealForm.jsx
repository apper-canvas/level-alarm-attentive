...
setFormData({
        ...
        closeDate: '',
stage: deal?.stage || 'Lead',
        probability: deal?.probability || (deal?.stage === 'Lead' ? 10 : deal?.stage === 'Qualified' ? 25 : deal?.stage === 'Proposal' ? 50 : deal?.stage === 'Negotiation' ? 75 : deal?.stage === 'Closed Won' ? 100 : deal?.stage === 'Closed Lost' ? 0 : 10),
        source: 'Inbound',
        priority: 'Medium',
        assignedTo: 'John Smith',
        products: [],
